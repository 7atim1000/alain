        ...
        <div className="min-h-screen bg-black">
            ...
            <div className="max-w-full mx-auto p-0 m-0">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 p-0 m-0 items-center justify-center w-full">
                    ...
                    <div className="flex flex-col items-center  justify-center p-0 m-0 mr-7"> 
                    ...
                    <div className="flex flex-col items-center justify-center p-0 m-0 z-10"> {/* z-index to ensure it's on top */}
                        ...
                        <div className="w-[580px] h-[580px]  rounded-full px-11 flex flex-col items-center justify-center p-0 m-0 relative">

                             <div className="absolute inset-0 rounded-full pointer-events-none"
                                style={{
                                    background: 'conic-gradient(from 195deg, #9ca3af 15%, #9ca3af 0%, transparent 105%, transparent 0%)',
                                    padding: '2.5px',
                                    mask: 'linear-gradient(#fff, #fff) content-box, linear-gradient(#fff, #fff)',
                                    maskComposite: 'exclude'
                                }}
                    ...
                    <div className="flex flex-col items-center justify-center p-0 m-0 ml-7">  
                        <div className="w-115 h-115  rounded-full p-6 flex items-center justify-center relative p-0 m-0 relative">
                            ...
                            <div className="w-50 h-50  rounded-full flex flex-col items-center justify-center bg-black z-10 absolute">
                               ...
                               <div className="absolute inset-0 rounded-full "
                                style={{
                                    background: 'conic-gradient(from 260deg, #9ca3af 0%, #9ca3af 0%, transparent 120%, transparent 100%)',
                                    padding: '1.5px',
                                    mask: 'linear-gradient(#fff, #fff) content-box, linear-gradient(#fff, #fff)',
                                    maskComposite: 'exclude'
                                }}>
                                ...
                                <p className="text-white text-sm mt-3 text-center">Data Factory</p>
