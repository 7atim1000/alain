...
const registerController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { user, token } = yield AuthService.RegisterService({
            fullName,
            email,
            password
        });
...
const loginController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { user, token } = yield AuthService.loginSerivce({
            email,
            password
        });
...
const UpdateProfileController = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield AuthService.UpdateProfileService(userId, updateData);
        res.json(result);
    }
    catch (error) {
        console.log(error.message);
